...
<nav class="navbar navbar-default">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Abarrotera</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/abarrotera/admin/categoria">Categorias</a></li>
            <li><a href="/abarrotera/admin/marca">Marca</a></li>
            <li><a href="/abarrotera/admin/proveedor">Proveedor</a></li>
            <li><a href="/abarrotera/admin/sucursal">Sucursal</a></li>
            <li><a href="/abarrotera/admin/unidad_medida">Unidad Medida</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="/abarrotera/admin/promocion/nuevo.php">Promociones</a></li>
        <li class="dropdown">
